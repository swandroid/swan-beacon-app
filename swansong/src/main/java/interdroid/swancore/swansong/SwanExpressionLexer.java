// $ANTLR 3.4 SwanExpression.g 2018-06-18 22:36:56
...
public class SwanExpressionLexer extends Lexer {
	...
	public String getGrammarFileName() { return "SwanExpression.g"; }
	...
	public final void mINT() throws RecognitionException {
		try {
			int _type = INT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:396:5: ( ( '-' )? ( '0' .. '9' )+ )
			// SwanExpression.g:396:9: ( '-' )? ( '0' .. '9' )+
			{
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:399:5: ( ( HTTP | HTTPS )? ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '/' | '-' | '.' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '/' | '-' | '.' )* ) )
			// SwanExpression.g:399:9: ( HTTP | HTTPS )? ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '/' | '-' | '.' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '/' | '-' | '.' )* )
			{
				// SwanExpression.g:399:9: ( HTTP | HTTPS )?
				int alt18=3;
				...
				// SwanExpression.g:399:24: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '/' | '-' | '.' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '/' | '-' | '.' )* )
				// SwanExpression.g:399:25: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '/' | '-' | '.' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '/' | '-' | '.' )*
				{
					...
					// SwanExpression.g:399:70: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '/' | '-' | '.' )*
					loop19:
					do {
						int alt19=2;
						int LA19_0 = input.LA(1);

						if ( ((LA19_0 >= '-' && LA19_0 <= '9')||(LA19_0 >= 'A' && LA19_0 <= 'Z')||LA19_0=='_'||(LA19_0 >= 'a' && LA19_0 <= 'z')) ) {
							alt19=1;
						}
	...
	public final void mFLOAT() throws RecognitionException {
		try {
			int _type = FLOAT;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:403:5: ( ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )? | ( '-' )? '.' ( '0' .. '9' )+ ( EXPONENT )? | ( '-' )? ( '0' .. '9' )+ EXPONENT )
			int alt29=3;
			alt29 = dfa29.predict(input);
			switch (alt29) {
				case 1 :
					// SwanExpression.g:403:9: ( '-' )? ( '0' .. '9' )+ '.' ( '0' .. '9' )* ( EXPONENT )?
				{
					// SwanExpression.g:403:9: ( '-' )?
					int alt20=2;
					...
					// SwanExpression.g:403:44: ( EXPONENT )?
					int alt23=2;
				...
				break;
				case 2 :
					// SwanExpression.g:404:9: ( '-' )? '.' ( '0' .. '9' )+ ( EXPONENT )?
				{
					...
					// SwanExpression.g:404:32: ( EXPONENT )?
					int alt26=2;
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = WS;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:408:5: ( ( ' ' | '\\t' | '\\r' | '\\n' ) )
			// SwanExpression.g:408:9: ( ' ' | '\\t' | '\\r' | '\\n' )
			{
	...
	public final void mSTRING() throws RecognitionException {
		try {
			...
			// SwanExpression.g:417:5: ( '\\'' ( ESC_SEQ |normal=~ ( '\\'' | '\\\\' ) )* '\\'' )
			// SwanExpression.g:418:5: '\\'' ( ESC_SEQ |normal=~ ( '\\'' | '\\\\' ) )* '\\''
			{
				...
				do {
					...
					switch (alt30) {
						case 1 :
							// SwanExpression.g:419:7: ESC_SEQ
						{
							mESC_SEQ();
	...
	public final void mESC_SEQ() throws RecognitionException {
		try {
			...
			// SwanExpression.g:431:5: ( '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '/' | '\\\\' | ( 'u' )+ i= HEX_DIGIT j= HEX_DIGIT k= HEX_DIGIT l= HEX_DIGIT ) )
			// SwanExpression.g:431:9: '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' | '/' | '\\\\' | ( 'u' )+ i= HEX_DIGIT j= HEX_DIGIT k= HEX_DIGIT l= HEX_DIGIT )
			{
				match('\\');
				...
				switch (alt32) {
					...
					break;
					case 10 :
						// SwanExpression.g:441:17: ( 'u' )+ i= HEX_DIGIT j= HEX_DIGIT k= HEX_DIGIT l= HEX_DIGIT
					{
						// SwanExpression.g:441:17: ( 'u' )+
						int cnt31=0;
						loop31:
						do {
							int alt31=2;
						...
						int iStart1132 = getCharIndex();
						int iStartLine1132 = getLine();
						int iStartCharPos1132 = getCharPositionInLine();
						mHEX_DIGIT();
						i = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, iStart1132, getCharIndex()-1);
						i.setLine(iStartLine1132);
						i.setCharPositionInLine(iStartCharPos1132);


						int jStart1136 = getCharIndex();
						int jStartLine1136 = getLine();
						int jStartCharPos1136 = getCharPositionInLine();
						mHEX_DIGIT();
						j = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, jStart1136, getCharIndex()-1);
						j.setLine(jStartLine1136);
						j.setCharPositionInLine(jStartCharPos1136);


						int kStart1140 = getCharIndex();
						int kStartLine1140 = getLine();
						int kStartCharPos1140 = getCharPositionInLine();
						mHEX_DIGIT();
						k = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, kStart1140, getCharIndex()-1);
						k.setLine(kStartLine1140);
						k.setCharPositionInLine(kStartCharPos1140);


						int lStart1144 = getCharIndex();
						int lStartLine1144 = getLine();
						int lStartCharPos1144 = getCharPositionInLine();
						mHEX_DIGIT();
						l = new CommonToken(input, Token.INVALID_TOKEN_TYPE, Token.DEFAULT_CHANNEL, lStart1144, getCharIndex()-1);
						l.setLine(lStartLine1144);
						l.setCharPositionInLine(lStartCharPos1144);
	...
	public final void mCONFIG_VAL() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// SwanExpression.g:445:5: ( '=' ( STRING | ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '/' | ':' | '=' | '&' | '_' | '\"' )* ) )
			// SwanExpression.g:445:9: '=' ( STRING | ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '/' | ':' | '=' | '&' | '_' | '\"' )* )
			{
				match('=');

				// SwanExpression.g:445:13: ( STRING | ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '/' | ':' | '=' | '&' | '_' | '\"' )* )
				int alt34=2;
				...
				switch (alt34) {
					case 1 :
						// SwanExpression.g:445:14: STRING
					{
						mSTRING();
					...
					break;
					case 2 :
						// SwanExpression.g:450:11: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '/' | ':' | '=' | '&' | '_' | '\"' )*
					{
						// SwanExpression.g:450:11: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '.' | '/' | ':' | '=' | '&' | '_' | '\"' )*
						loop33:
						do {
	...
	public final void mEXPONENT() throws RecognitionException {
		try {
			// SwanExpression.g:456:10: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
			// SwanExpression.g:456:12: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
			{
	...
	public final void mHEX_DIGIT() throws RecognitionException {
		try {
			// SwanExpression.g:459:11: ( ( '0' .. '9' | 'a' .. 'f' | 'A' .. 'F' ) )
			// SwanExpression.g:
			{
	...
	public void mTokens() throws RecognitionException {
		// SwanExpression.g:1:8: ( T__42 | T__43 | T__44 | T__45 | T__46 | T__47 | T__48 | T__49 | T__50 | T__51 | TIME_UNIT | OR | AND | NOT | CONFIG_IS | CONFIG_HASH | CONFIG_TILT | EQUALS | NOTEQUALS | LT | LTEQ | GT | GTEQ | PLUS | MINUS | MULT | DIV | MOD | REGEX | CONTAINS | ALL | ANY | NONE | MAX | MIN | MEAN | MEDIAN | HTTP | HTTPS | INT | ID | FLOAT | WS | STRING | CONFIG_VAL )
		int alt37=45;
	...
	static final String DFA37_eotS =
			"\5\uffff\1\54\5\uffff\6\57\1\uffff\2\51\1\uffff\2\51\1\76\2\51\1"+
					"\102\2\uffff\1\105\1\107\1\uffff\1\110\1\uffff\1\113\1\uffff\4\51"+
					"\1\120\4\uffff\2\51\1\uffff\1\57\6\51\2\21\4\51\2\uffff\2\51\1\147"+
					"\7\uffff\1\120\1\51\1\uffff\4\51\1\uffff\4\51\1\164\1\165\2\51\1"+
					"\164\1\165\2\51\1\24\1\172\1\173\1\24\1\172\1\173\1\76\1\51\1\76"+
					"\1\51\1\uffff\10\51\1\uffff\3\51\2\uffff\1\u0086\1\51\1\u0086\1"+
					"\51\2\uffff\2\u0089\6\51\1\uffff\1\51\1\uffff\2\51\1\uffff\2\u0092"+
					"\2\51\2\uffff\2\u0097\1\uffff\2\51\1\u009a\2\uffff\2\51\1\uffff"+
					"\1\u009e\2\u009f\2\uffff";
	static final String DFA37_eofS =
			"\u00a0\uffff";
	static final String DFA37_minS =
			"\1\11\4\uffff\1\55\5\uffff\6\55\1\uffff\1\162\1\122\1\uffff\1\154"+
					"\1\114\1\75\1\157\1\117\1\42\2\uffff\2\75\1\uffff\1\55\1\uffff\1"+
					"\55\1\uffff\1\145\1\105\1\157\1\117\1\55\4\uffff\1\60\1\164\1\uffff"+
					"\1\55\1\170\1\156\1\141\1\130\1\116\1\101\2\55\1\144\1\154\1\104"+
					"\1\114\2\uffff\1\156\1\116\1\42\7\uffff\1\55\1\60\1\uffff\1\147"+
					"\1\107\1\156\1\116\1\uffff\1\60\2\53\1\160\2\55\1\156\1\151\2\55"+
					"\1\116\1\111\7\55\1\145\1\55\1\105\1\uffff\1\145\1\105\1\164\1\124"+
					"\1\60\1\53\2\60\1\uffff\2\60\1\72\2\uffff\1\55\1\141\1\55\1\101"+
					"\2\uffff\2\55\1\170\1\130\1\141\1\101\2\60\1\57\1\72\1\uffff\1\156"+
					"\1\116\1\uffff\2\55\1\151\1\111\2\57\2\55\1\uffff\1\156\1\116\1"+
					"\55\1\57\1\uffff\1\163\1\123\1\uffff\3\55\2\uffff";
	static final String DFA37_maxS =
			"\1\176\4\uffff\1\172\5\uffff\6\172\1\uffff\1\162\1\122\1\uffff\1"+
					"\156\1\116\1\75\1\157\1\117\1\172\2\uffff\1\76\1\75\1\uffff\1\172"+
					"\1\uffff\1\172\1\uffff\1\145\1\105\1\157\1\117\1\172\4\uffff\1\145"+
					"\1\164\1\uffff\1\172\1\170\1\156\1\144\1\130\1\116\1\104\2\172\1"+
					"\171\1\154\1\131\1\114\2\uffff\1\164\1\124\1\172\7\uffff\1\172\1"+
					"\71\1\uffff\1\147\1\107\1\156\1\116\1\uffff\1\145\2\71\1\160\2\172"+
					"\1\156\1\151\2\172\1\116\1\111\7\172\1\145\1\172\1\105\1\uffff\1"+
					"\145\1\105\1\164\1\124\1\145\3\71\1\uffff\2\71\1\163\2\uffff\1\172"+
					"\1\141\1\172\1\101\2\uffff\2\172\1\170\1\130\1\141\1\101\2\71\1"+
					"\57\1\72\1\uffff\1\156\1\116\1\uffff\2\172\1\151\1\111\2\57\2\172"+
					"\1\uffff\1\156\1\116\1\172\1\57\1\uffff\1\163\1\123\1\uffff\3\172"+
					"\2\uffff";
	static final String DFA37_acceptS =
			"\1\uffff\1\1\1\2\1\3\1\4\1\uffff\1\6\1\7\1\10\1\11\1\12\6\uffff"+
					"\1\14\2\uffff\1\15\6\uffff\1\20\1\21\2\uffff\1\30\1\uffff\1\32\1"+
					"\uffff\1\34\5\uffff\1\51\1\53\1\54\1\5\2\uffff\1\13\15\uffff\1\23"+
					"\1\16\3\uffff\1\17\1\55\1\25\1\24\1\27\1\26\1\31\2\uffff\1\33\4"+
					"\uffff\1\50\26\uffff\1\22\10\uffff\1\52\3\uffff\1\42\1\43\4\uffff"+
					"\1\40\1\37\12\uffff\1\44\2\uffff\1\41\10\uffff\1\35\4\uffff\1\45"+
					"\2\uffff\1\46\3\uffff\1\47\1\36";
	static final String DFA37_specialS =
			"\u00a0\uffff}>";
	static final String[] DFA37_transitionS = {
			"\2\52\2\uffff\1\52\22\uffff\1\52\1\27\1\uffff\1\33\1\1\1\43"+
					"\1\24\1\53\1\2\1\3\1\41\1\37\1\4\1\40\1\5\1\42\12\50\1\6\1\uffff"+
					"\1\35\1\32\1\36\1\7\1\10\1\26\1\51\1\47\4\51\1\14\4\51\1\16"+
					"\1\31\1\23\2\51\1\45\1\20\7\51\4\uffff\1\51\1\uffff\1\25\1\51"+
					"\1\46\4\51\1\13\4\51\1\15\1\30\1\22\2\51\1\44\1\17\7\51\1\11"+
					"\1\21\1\12\1\34",
			"",
			"",
			"",
			"",
			"\3\51\12\55\7\uffff\32\51\4\uffff\1\51\1\uffff\32\51",
			"",
			"",
			"",
			"",
			"",
			"\15\51\7\uffff\32\51\4\uffff\1\51\1\uffff\23\51\1\56\6\51",
			"\15\51\7\uffff\32\51\4\uffff\1\51\1\uffff\32\51",
			"\15\51\7\uffff\32\51\4\uffff\1\51\1\uffff\1\61\3\51\1\63\3"+
					"\51\1\62\11\51\1\60\7\51",
			"\15\51\7\uffff\1\64\3\51\1\66\3\51\1\65\21\51\4\uffff\1\51"+
					"\1\uffff\32\51",
			"\15\51\7\uffff\32\51\4\uffff\1\51\1\uffff\32\51",
			"\15\51\7\uffff\32\51\4\uffff\1\51\1\uffff\32\51",
			"",
			...
			"\1\77",
			"\1\100",
			"\1\103\3\uffff\2\103\6\uffff\15\103\2\uffff\1\101\3\uffff\32"+
			...
			"\1\106",
			"",
			"\1\51\1\112\1\51\12\111\7\uffff\32\51\4\uffff\1\51\1\uffff"+
					"\32\51",
			"",
			"\15\51\7\uffff\32\51\4\uffff\1\51\1\uffff\32\51",
			"",
			...
			"\1\116",
			"\1\117",
			"\1\51\1\121\1\51\12\111\7\uffff\4\51\1\122\25\51\4\uffff\1"+
					"\51\1\uffff\4\51\1\122\25\51",
			"",
			"",
			"",
			"",
			"\12\55\13\uffff\1\123\37\uffff\1\123",
			"\1\124",
			"",
			"\15\51\7\uffff\32\51\4\uffff\1\51\1\uffff\32\51",
			"\1\125",
			...
			"\1\144\5\uffff\1\143",
			"\1\146\5\uffff\1\145",
			"\1\103\3\uffff\1\103\7\uffff\15\103\2\uffff\1\103\3\uffff\32"+
					"\103\4\uffff\1\103\1\uffff\32\103",
			"",
			"",
			"",
			...
			"\1\153",
			"",
			"\12\154\13\uffff\1\155\37\uffff\1\155",
			"\1\160\1\uffff\1\156\2\uffff\12\157",
			"\1\160\1\uffff\1\161\2\uffff\12\162",
			"\1\163",
			"\15\51\7\uffff\32\51\4\uffff\1\51\1\uffff\32\51",
			"\15\51\7\uffff\32\51\4\uffff\1\51\1\uffff\32\51",
			"\1\166",
	...
	class DFA37 extends DFA {
		...
		public String getDescription() {
			return "1:1: Tokens : ( T__42 | T__43 | T__44 | T__45 | T__46 | T__47 | T__48 | T__49 | T__50 | T__51 | TIME_UNIT | OR | AND | NOT | CONFIG_IS | CONFIG_HASH | CONFIG_TILT | EQUALS | NOTEQUALS | LT | LTEQ | GT | GTEQ | PLUS | MINUS | MULT | DIV | MOD | REGEX | CONTAINS | ALL | ANY | NONE | MAX | MIN | MEAN | MEDIAN | HTTP | HTTPS | INT | ID | FLOAT | WS | STRING | CONFIG_VAL );";
		}
	}

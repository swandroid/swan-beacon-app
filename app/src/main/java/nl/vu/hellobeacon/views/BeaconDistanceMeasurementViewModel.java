...
public class BeaconDistanceMeasurementViewModel extends AndroidViewModel {
    ...
    public int getMaxIndex() {
        return repository.getBeaconDistanceMeasurementIndex();
    }

    public void insert(BeaconDistanceMeasurement beaconDistanceMeasurement) {
        repository.insertBeaconDistanceMeasurement(beaconDistanceMeasurement);
    }
